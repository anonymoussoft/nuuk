 ...
 * File: component.cpp
 * Time-stamp: <2019-03-14 09:48:16>
 * Description:
 * Author: bin.gao
 *
 * =================================================================
...
LUACOB_BIND_CLASS_MEMBER_FUNCTION(getInterceptsMouseClicks, LUACOB_ARGS(luacob::_out, luacob::_out))
...
LUACOB_BIND_CLASS_MEMBER_FUNCTION(paint, LUACOB_ARGS(luacob::_out))
LUACOB_BIND_CLASS_MEMBER_FUNCTION(paintOverChildren, LUACOB_ARGS(luacob::_out))
...
LUACOB_BIND_CLASS_MEMBER_FUNCTION(copyAllExplicitColoursTo, LUACOB_ARGS(luacob::_out))
