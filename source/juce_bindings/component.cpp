...
LUACOB_BIND_CLASS_MEMBER_FUNCTION_MULTIRET(getInterceptsMouseClicks, LUACOB_ARGS(luacob::_out, luacob::_out))
...
LUACOB_BIND_CLASS_MEMBER_FUNCTION_MULTIRET(copyAllExplicitColoursTo, LUACOB_ARGS(luacob::_out))
